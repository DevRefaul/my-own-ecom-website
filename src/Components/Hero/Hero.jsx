...
const Hero = () => {
  return (
    <div className="bg-yellow-50">
      <div className="relative flex flex-col-reverse px-4 py-16 mx-auto lg:block lg:flex-col lg:py-32 xl:py-36 md:px-8 sm:max-w-xl md:max-w-full">
          ...
          <div className="mb-16 lg:pr-5 lg:max-w-lg lg:mb-0">
            <div className="max-w-xl mb-6">
              ...
              <p className="text-base text-gray-700 md:text-lg">
                Subscribe today and get a lot of offers and news
              </p>
            </div>
            <form>
              ...
              <div className="flex items-center mt-4">
                ...
                <a
                  href="/"
                  aria-label=""
                  className="inline-flex items-center font-semibold transition-colors duration-200 text-purple-400 hover:text-purple-800 focus:shadow-outline focus:outline-none"
                >
                  Learn more
                </a>
              </div>
