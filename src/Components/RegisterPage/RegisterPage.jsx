...
const RegisterPage = () => {
  ...
  const { handleGoogleSignUp, handleEmailPasswordSignUp, handleGithubSignUp } =
    userContext;
  ...
  // github signup
  const handleGithubSignUpBtn = () => {
    handleGithubSignUp()
      .then((result) => {
        console.log(result.user);
        toast.success("Successfully Created Account With GitHub");
        navigate("/home");
      })
      .catch((err) => {
        console.error(err);
      ...
      <div className="py-2">
        {error === "Firebase: Error (auth/email-already-in-use)." ? (
          <h2 className="text-lg font-semibold text-center text-red-600">
            E-mail alreday exists. <br /> Use another E-mail.
          </h2>
        ) : (
          ""
        )}
